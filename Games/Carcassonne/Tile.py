...
"""
import cv2
from Games.Carcassonne.Tile_dict import TILE_DESC_DICT, HAS_NOT_FARM, FARM_OPENINGS_DICT, FARM_CITY_INDEX_DICT, HAS_CITY, CITY_OPENINGS_DICT, IS_DOUBLE, HAS_ROAD, ROAD_OPENINGS_DICT, HAS_MONASTERY, NO_ROTATIONS, ONE_ROTATION, TILE_PROPERTIES_DICT, MEEPLE_LOC_DICT
...
class Tile:
    def __init__(self, TileIndex, RunInit = True):
        ...
        # image location
        self.image = "Games/Carcassonne/pygame_images/" + str(self.TileIndex) + ".png"
