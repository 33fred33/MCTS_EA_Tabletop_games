# file imports
from pygameSettings import GRID, GRID_SIZE, GRID_WINDOW_HEIGHT, GRID_WINDOW_WIDTH, MEEPLE_SIZE, BLACK, WHITE, LIGHTGREEN, BROWN
from pygameSettings import FONT_MEEPLE_IMAGE, FONT_MEEPLE_MENU, RED, BLUE, DARK_GREEN
...
def drawGrid(DisplayScreen):
    ...
    # add game mat
    gameMat = pygame.image.load('Games/Carcassonne/pygame_images/game_mat.jpg')
...
def placeTile(Tile, Rotation, x, y, DisplayScreen):
    ...
    # load image
    image = pygame.image.load('Games/Carcassonne/pygame_images/' + str(TileIndex) + '.png')
...
def playMove(NextTile, player, Carcassonne, TileIndex, current_index, ManualMove=None,):
    ...
    if player.isAIPlayer:
        selectedMove = player.choose_action(Carcassonne)
    else:
