# file imports
from Tile import Tile, showImage

from pygameSettings import MEEPLE_LABEL_X, MEEPLE_LABEL_Y, MEEPLE_LABEL_SHIFT_X, MEEPLE_LABEL_SHIFT_Y
from pygameSettings import GRID_WINDOW_WIDTH, MENU_WIDTH, BLUE, WHITE, RED, GREEN, COFFEEBROWN, BROWN, MEEPLE_CHOICE_HIGHLIGHT
from pygameSettings import FONT_MEEPLE_IMAGE, FONT_MEEPLE_MENU, BLACK
...
class nextTile:
    ...
    def __init__(self, Carcassonne, displayScreen, RunInit = True):
        ...
        if RunInit:
            ...
            self.leftRotImage = pygame.image.load('Games/Carcassonne/pygame_images/left_rotate.png')
            self.rightRotImage = pygame.image.load('Games/Carcassonne/pygame_images/right_rotate.png')
    ...
    def possibleCoordinates(self):
        ...
        """
        availableMoves = self.Carcassonne.available_actions
